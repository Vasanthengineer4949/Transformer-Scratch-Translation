...
class ClassificationDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        decoder_inp_tokens = torch.cat([self.sos_token, decoder_inp_tokens, decoder_inp_pad_tokens], dim=0) # Decoder input tokens padded
        ...
        model_inp["decoder_input_ids"] = decoder_inp_tokens
